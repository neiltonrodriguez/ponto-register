                    ...
                    <li class="px-6 py-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900">{{ $timeClock->user->name }}</div>
                                    <div class="text-sm text-gray-500">{{ $timeClock->user->position }}</div>
                                </div>
                            </div>
                            <div class="flex items-center">
                                <div class="text-sm text-gray-900">
                                    <div class="font-medium">{{ $timeClock->clocked_at->format('d/m/Y H:i:s') }}</div>
                                    <div class="text-gray-500">{{ $timeClock->clocked_at->diffForHumans() }}</div>
                                </div>
                            </div>
                        </div>
                    </li>
